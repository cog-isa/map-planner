...
class ISearch
{
    public:
        ...
        SearchResult startSearch(ILogger *Logger, const JSON_Map &Map, const EnvironmentOptions &options);
    ...
    protected:
        ...
        virtual std::list<Node> findSuccessors(Node curNode, const JSON_Map &map, const EnvironmentOptions &options);
        ...
        virtual Node resetParent(Node current, Node parent, const JSON_Map &map, const EnvironmentOptions &options) {return current;}//Function for Theta*
