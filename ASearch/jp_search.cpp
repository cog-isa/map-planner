...
void JP_Search::findJP(int move_i, int move_j, Node curNode, const JSON_Map &map, std::list<Node> &successors, const EnvironmentOptions &options)
{
    bool findOK = false;
    while(!findOK) {
...
bool JP_Search::findNeighbors(int move_i, int move_j, Node curNode, const JSON_Map &map, const EnvironmentOptions &options)
{
...
std::list<Node> JP_Search::findSuccessors(Node curNode, const JSON_Map &map, const EnvironmentOptions &options)
{
