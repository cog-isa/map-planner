...
bool Theta::lineOfSight(int i1, int j1, int i2, int j2, const JSON_Map &map, bool cutcorners)
{
...
Node Theta::resetParent(Node current, Node parent, const JSON_Map &map, const EnvironmentOptions &options )
{
